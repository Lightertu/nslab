# Readings about alljoyn need to be done 
* [Core Framework Introduction](https://allseenalliance.org/framework/documentation/learn/core)
    - [**Standard Core Introduction**](https://allseenalliance.org/framework/documentation/learn/core/standard-core)
    - [**Thin Core Introduction**](https://allseenalliance.org/framework/documentation/learn/core/thin-core)
    - [About Announcement](https://allseenalliance.org/framework/documentation/learn/core/about-announcement)
    - [Routing Node Configuration](https://allseenalliance.org/framework/documentation/learn/core/rn_config)
    - [Events and Actions](https://allseenalliance.org/framework/documentation/learn/core/events-and-actions)
